  ...
  const features = [
    {
      ...
      description: "Quickly locate available parking spots near your destination with our intuitive search system.",
    ...
    },
    {
      ...
      description: "Access parking spaces across different locations with a single account.",
    ...
    },
    {
      ...
      description: "Get instant updates on parking availability and receive timely notifications.",
      color: "bg-amber-50 dark:bg-amber-900/20 border-amber-100 dark:border-amber-800/30",
    },
    {
      icon: <CreditCard className="h-6 w-6 text-purple-500 dark:text-purple-400" />,
      title: "Secure Payments",
      description: "Make hassle-free payments with our secure online payment gateway.",
    ...
    },
    {
      ...
      description: "Track your parking history and expenses with our comprehensive analytics.",
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          >
            ...
            <p className="text-lg text-zinc-600 dark:text-zinc-300">
              Our platform offers everything you need to make parking effortless and stress-free.
            </p>
          </motion.div>
        </div>
