...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="relative pt-20 pb-10 overflow-hidden bg-gradient-to-b from-white to-blue-50/30 dark:from-black dark:to-blue-950/10">
      {/* Decorative elements */}
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 max-w-7xl">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-16 border-b border-blue-100 dark:border-blue-900/30">
          ...
          <div className="space-y-6">
            <Link to="/" className="inline-flex items-center gap-2 group">
              <div className="relative">
                ...
                <div className="relative flex items-center justify-center h-10 w-10 bg-gradient-to-tr from-blue-500 to-indigo-600 dark:from-blue-600 dark:to-indigo-700 rounded-lg shadow-lg overflow-hidden transition-all">
            ...
            <p className="text-zinc-600 dark:text-zinc-300 max-w-lg">
              The modern solution to find and book parking spaces in real-time. EazyParking simplifies your parking experience with smart technology and seamless reservations.
            </p>
          ...
          <div className="lg:ml-auto lg:max-w-md">
            <h3 className="text-lg font-bold mb-3 text-zinc-800 dark:text-zinc-100">Subscribe to our Newsletter</h3>
            <p className="text-zinc-600 dark:text-zinc-300 mb-5">
              Stay updated with the latest features, tips, and parking availability in your area.
            </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 py-12">
          ...
          <div className="md:col-span-3">
            <h3 className="text-lg font-semibold mb-5 text-zinc-900 dark:text-zinc-100">Company</h3>
          ...
          <div className="md:col-span-3">
            <h3 className="text-lg font-semibold mb-5 text-zinc-900 dark:text-zinc-100">Services</h3>
            <ul className="space-y-3">
              {[
          ...
          <div className="md:col-span-3">
            <h3 className="text-lg font-semibold mb-5 text-zinc-900 dark:text-zinc-100">Resources</h3>
            <ul className="space-y-3">
              {[
          ...
          {/* Contact */}
          <div className="md:col-span-3">
            <h3 className="text-lg font-semibold mb-5 text-zinc-900 dark:text-zinc-100">Contact Us</h3>
        ...
        <div className="pt-8 border-t border-blue-100 dark:border-blue-900/30">
          ...
          <div className="flex items-center justify-center mt-6">
            <p className="text-xs text-zinc-400 dark:text-zinc-500">
              Made with <span className="text-red-500">❤</span> for smart parking solutions
            </p>
          </div>
        </div>
      </div>
